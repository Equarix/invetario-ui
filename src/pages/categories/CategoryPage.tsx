...
import type { ApiResponse, ResponseCategories } from "@/interface/response.interface";
...
export default function CategoryPage() {
  ...
  const { data } = useQuery<ApiResponse<ResponseCategories[]>>({
  ...
  return (
      <div className="flex flex-col p-4 h-full w-full">
        ...
        <section className="w-full grid grid-cols-4 gap-2 mt-4">
          ...
          <CreateCategory isOpen={isOpen} onClose={onOpenChange} />
      </div>
    );
}
